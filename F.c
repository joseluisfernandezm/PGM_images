...
int **F(int maximo){
  int matrix[5][4]={{maximo, maximo, maximo, maximo},{maximo, 0, 0, 0},{maximo, maximo, maximo, 0},{maximo, 0, 0, 0},{maximo, 0, 0, 0}};
  int **matriz_envio;
  int k, l;
  ...
  printf("Impresion de la matriz F\n");
  for(k=0;k<5;k++){
    for(l=0;l<4;l++){
      printf("%d ",matrix[k][l]);
    }
  ...
  /*printf("Impresion de la matriz envio\n");
